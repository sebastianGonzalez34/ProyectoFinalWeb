...
require_once '../includes/sanitize.php'; // AGREGAR ESTA LÍNEA
                ...
                <?php if ($ticket_detalle['estado'] != 'Cerrado'): ?>
                    <?php if (!$ticket_detalle['id_agente_asignado']): ?>
                        <form method="POST" style="margin-bottom: 1rem;">
                            ...
                            <button type="submit" name="asignar_ticket" class="btn btn-primary">Asignarme este Ticket</button>
                        </form>
                    <?php elseif ($ticket_detalle['id_agente_asignado'] == $user_id): ?>
                        <form method="POST">
                            <input type="hidden" name="ticket_id" value="<?php echo $ticket_detalle['id_ticket']; ?>">
                            ...
                            <td>
                                ...
                                <?php if (!$ticket['id_agente_asignado'] && $ticket['estado'] != 'Cerrado'): ?>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <button type="submit" name="asignar_ticket" class="btn btn-warning btn-sm">Asignarme</button>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>
